...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupExpressionDisplay() {
        ...
        expressionDisplay.setOnClickListener {
            cursorPosition = expressionDisplay.selectionStart
        }
    }
    ...
    private fun showHistory() {
        ...
        val recyclerView = dialogView.findViewById<RecyclerView>(R.id.historyRecyclerView)
        val clearBtn = dialogView.findViewById<Button>(R.id.clearHistoryBtn)
        ...
        val adapter = HistoryAdapter(
            ...
            onItemClick = { item ->
                ...
                updateDisplay()
                autoCalculate()
                (dialogView.parent as? android.view.View)?.let { /* close */ }
            },
            onDeleteClick = { position ->
                historyManager.removeItem(position)
                (dialogView.parent as? android.view.View)?.let { /* refresh */ }
            }
        )
